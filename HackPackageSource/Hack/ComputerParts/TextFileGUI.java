...
public interface TextFileGUI extends ComputerPartGUI {
     ...
     */
    void removeTextFileListener(TextFileEventListener listener);
     ...
     */
    void notifyTextFileListeners(String rowSrting, int rowIndex);
     ...
     */
    void setLineAt(int index, String line);
