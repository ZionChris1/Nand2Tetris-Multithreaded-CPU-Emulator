...
public interface HackTranslatorGUI {
     ...
     */
    void addHackTranslatorListener(HackTranslatorEventListener listener);

    /**
     * Un-registers the given HackTranslatorEventListener from being a listener to this GUI.
     */
    void removeHackTranslatorListener(HackTranslatorEventListener listener);
     ...
     */
    void notifyHackTranslatorListeners(byte action, Object data);
