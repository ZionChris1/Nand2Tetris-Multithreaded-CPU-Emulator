...
public class CPUEmulatorComponent extends HackSimulatorComponent implements CPUEmulatorGUI  {
    ...
    private static final int EMULATOR_WIDTH = 1318;
    ...
    private RegisterComponent a1;
    private RegisterComponent d1;
    private RegisterComponent pc1;
    ...
    private ALUComponent alu1;

    // The bus of the CPUEmulator.
    private BusComponent bus;
    private BusComponent bus1;
    ...
    public CPUEmulatorComponent() {
        ...
        alu1 = new ALUComponent();
        a = new RegisterComponent();
        a1 = new RegisterComponent();
        d = new RegisterComponent();
        d1 = new RegisterComponent();
        pc = new RegisterComponent();
        pc1 = new RegisterComponent();
        setRegistersNames();
        bus = new BusComponent(Color.blue);
        bus1 = new BusComponent(Color.blue);
        jbInit();
    ...
    public BusGUI getBus1() {return bus1; }
    ...
    private void jbInit() {
        ...
        pc1.setBounds(new Rectangle(35, 547, pc1.getWidth(), pc1.getHeight()));
        a.setBounds(new Rectangle(278, 527, a.getWidth(), a.getHeight()));
        a1.setBounds(new Rectangle(278, 547, a1.getWidth(), a1.getHeight()));
        d.setBounds(new Rectangle(646, 351, d.getWidth(), d.getHeight()));
        d1.setBounds(new Rectangle(646, 371, d1.getWidth(), d1.getHeight()));
        ...
        alu1.setBounds(new Rectangle(921, 414, alu1.getWidth(), alu1.getHeight()));

        bus.setBounds(new Rectangle(0, 0, EMULATOR_WIDTH , EMULATOR_HEIGHT));
        bus1.setBounds(new Rectangle(0, 0, EMULATOR_WIDTH , EMULATOR_HEIGHT));
