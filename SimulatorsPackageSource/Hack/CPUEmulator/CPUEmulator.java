...
public class CPUEmulator extends HackSimulator implements ComputerPartErrorEventListener {
    ...
    public CPUEmulator() {
        ...
        A.reset();
        PointerAddressRegisterAdapter A1 = new PointerAddressRegisterAdapter(null, ram);
        A1.reset();

        Register D = new Register(null);
        D.reset();
        Register D1 = new Register(null);
        D1.reset();

        PointerAddressRegisterAdapter PC = new PointerAddressRegisterAdapter(null, rom);
        PC.reset();
        PointerAddressRegisterAdapter PC1 = new PointerAddressRegisterAdapter(null, rom);
        PC1.reset1();
        PC1.setValueAt(0, (short)2, true);
        ...
        cpu = new CPU(ram, rom, A, D, PC, alu, bus, A1, D1, PC1, alu1, bus1);
    ...
    public CPUEmulator(CPUEmulatorGUI gui) {
        ...
        A.reset();
        PointerAddressRegisterAdapter A1 = new PointerAddressRegisterAdapter(gui.getA1(), ram);
        A1.addErrorListener(this);
        A1.reset();

        Register D = new Register(gui.getD());
        D.addErrorListener(this);
        D.reset();
        Register D1 = new Register(gui.getD1());
        D1.addErrorListener(this);
        D1.reset();

        PointerAddressRegisterAdapter PC = new PointerAddressRegisterAdapter(gui.getPC(), rom);
        PC.addErrorListener(this);
        PC.reset();
        PointerAddressRegisterAdapter PC1 = new PointerAddressRegisterAdapter(gui.getPC1(), rom);
        PC1.addErrorListener(this);
        PC1.reset1();
        PC1.setValueAt(0, (short)2, true);
        ...
        alu.reset();
        ALU alu1 = new ALU(gui.getALU1());
        alu1.reset();

        Bus bus = new Bus(gui.getBus());
        bus.reset();
        Bus bus1 = new Bus(gui.getBus1());
        bus1.reset();
    ...
    private void hideHighlightes() {
        ...
        cpu.getA1().hideHighlight();
        cpu.getD().hideHighlight();
        cpu.getD1().hideHighlight();
        cpu.getPC().hideHighlight();
        cpu.getPC1().hideHighlight();
        cpu.getALU().hideHighlight();
        cpu.getALU1().hideHighlight();
    }
    ...
    public void setAnimationMode(int newAnimationMode) {
        if (gui != null) {
            ...
            if (newAnimationMode == HackController.NO_DISPLAY_CHANGES &&
                ...
                cpu.getA1().disableUserInput();
                cpu.getD1().disableUserInput();
                cpu.getPC1().disableUserInput();
            ...
            if (newAnimationMode != HackController.NO_DISPLAY_CHANGES &&
                ...
                cpu.getA1().enableUserInput();
                cpu.getD1().enableUserInput();
                cpu.getPC1().enableUserInput();
        ...
        cpu.getA1().setAnimate(animate);
        cpu.getD1().setAnimate(animate);
        cpu.getPC1().setAnimate(animate);
        cpu.getALU1().setAnimate(animate);
        cpu.getBus1().setAnimate(animate);
        ...
        cpu.getA1().setDisplayChanges(displayChanges);
        cpu.getD1().setDisplayChanges(displayChanges);
        cpu.getPC1().setDisplayChanges(displayChanges);
        cpu.getALU1().setDisplayChanges(displayChanges);
    }
    ...
    public void setNumericFormat(int formatCode) {
        ...
        cpu.getA1().setNumericFormat(formatCode);
        cpu.getD1().setNumericFormat(formatCode);
        cpu.getPC1().setNumericFormat(formatCode);
        cpu.getALU1().setNumericFormat(formatCode);
    }
    ...
    public void refresh() {
        ...
        cpu.getA1().refreshGUI();
        cpu.getD1().refreshGUI();
        cpu.getPC1().refreshGUI();
        cpu.getALU1().refreshGUI();
